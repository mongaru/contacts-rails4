Rails.application.routes.draw do
  ...
  # JTL - in this case the controller used is the one shiped with devise
  # devise_for :members

  # JTL - in this case the controller used is the one generated on the folder controllers/members
  devise_for :members, controllers: { sessions: 'members/sessions' }

  # JTL - couldn't make it work
